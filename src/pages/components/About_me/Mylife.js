  ...
  return (
    <div className="flex items-center justify-center h-full">
      <div className="block md:py-16 lg:px-16 xl:px-40 2xl:px-48" style={{ marginLeft: '24px', marginRight: '24px' }}>
        <div className="page-title font-light text-3xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl tracking-tight min-h-[1.2em]" style={{ marginBottom: '200px', marginTop: '150px' }}>
