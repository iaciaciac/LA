    ...
    <header className="relative top-0 left-0 right-0 z-50 w-full mb-[10px]">
      <nav className="flex items-center justify-between w-full px-6 py-6 md:px-12" role="navigation">
        <div className="flex-shrink-0">
          <Link href="/">
            <span className="font-bold text-lg tracking-widest text-black dark:text-gray-200 uppercase">CAICAI</span>
          </Link>
        </div>

        <div className="flex gap-8 text-sm font-medium text-black dark:text-gray-200">
          <Link href="/">
